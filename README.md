...
|---|---:|---:|---:|---:|---:|
| 病院 | 7,715 | 7,527 | 7,437 | 90 | 188 |
| 診療所 | 80,155 | 77,142 | 75,071 | 2,071 | 3,013 |
| 歯科診療所 | 54,637 | 52,638 | 51,310 | 1,328 | 1,999 |
| 助産所 | 2,138 | 1,788 | 1,668 | 120 | 350 |
| 薬局 | 61,398 | 57,405 | 54,028 | 3,377 | 3,993 |
| 合計 | 206,043 | 196,500 | 189,514 | 6,986 | 9,543 |

「座標を付与」6,986件のうち286件は、元データに座標がありながら住所から1km以上
離れていたため住所側を採ったものです。
判定の条件は [docs/processing.md](docs/processing.md) の
「元データの座標が住所から離れている場合」にまとめています。
